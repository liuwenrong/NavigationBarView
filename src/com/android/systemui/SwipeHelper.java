...
public class SwipeHelper implements Gefingerpoken {
    ...
    public void dismissChild(final View view, float velocity, final Runnable endAction,
        ...
        mHandler.postDelayed(
				...
				{
					public void run() {
//						if(view instanceof NotificationOtherListBarContainer){
//				        	mCallback.updateNotificationsOther(view);
//				        }
					};
				},duration/2);
    ...
    public void dismissChildNoAnimated(final View view, final Runnable endAction, boolean needAnim) {
        final View animView = mCallback.getChildContentView(view);
        final boolean canAnimViewBeDismissed = mCallback.canChildBeDismissed(view);
        float newPos;
        boolean isLayoutRtl = view.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
        ...
        if(!needAnim){
        	...
        	dismissChild(view, mVelocity, null, 0, false, 0);
        }
    }
    ...
    public interface Callback {
        ...
        void updateNotificationsOther(View v);
