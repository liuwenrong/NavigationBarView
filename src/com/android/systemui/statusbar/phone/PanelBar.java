...
public abstract class PanelBar extends FrameLayout {
    ...
    public static final void LOG(String fmt, Object... args) {
        LogHelper.logE(TAG, String.format(fmt, args));
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!panelsEnabled() || isSuperSavePowerMode()) {
    ...
    public void panelExpansionChanged(PanelView panel, float frac, boolean expanded) {
        ...
        for (PanelView pv : mPanels) {
//            boolean hidePanel = !expanded && mBar != null
//                    && (mBar.getBarState() == StatusBarState.SHADE || !mBar.isKeyguardCurrentlySecure());
//            pv.setVisibility(hidePanel ? View.GONE : View.VISIBLE);
            ...
            if (expanded) {
                ...
                mPanelExpandedFractionSum += thisFrac; //(expanded ? thisFrac : 0);
    ...
    public boolean mIsPanelFullyOpened = false;
    public void onAllPanelsCollapsed() {
    	mIsPanelFullyOpened = false;
        if (DEBUG) LOG("onAllPanelsCollapsed");
    }

    public void onPanelFullyOpened(PanelView openPanel) {
    	mIsPanelFullyOpened = true;
...
//    	onTrackingStopped(panel, expand, KeyguardHostView.POSITION_NORMAL);
    }
